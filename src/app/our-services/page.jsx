...
<Header/>
    <div>
        ...
        <div style={{ width: "30%" }} className="imga">
          <img src="/image/pexels-tima-miroshnichenko-6200780.jpg" alt="" width={200} />
        </div>
      </div>
        </div>
        ...
        <div style={{ width: "80%", margin: "auto", gap: "0px" }}>
          ...
          <div className="flex">
            ...
            >
              ...
              <div>
                <div>
                  <img src="/image/0821202411020566c5c92d7be51.gif" alt="" width={250} />
                  <p></p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div>
                <div>
                  <img src="/image/0821202411031766c5c975cc7b2.gif" alt="" width={250} />
                  <p></p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div>
                <div>
                  <img src="/image/0821202411045566c5c9d744f0e.gif" alt="" width={250} />
                  <p></p>
                </div>
              </div>
            </div>
